...
public class Start implements Screen {
    ...
    public void show() {
        ...
        TextButton score= new TextButton("Highscore",skin);
        stage.addActor(start);
        score.setPosition(Gdx.graphics.getWidth()/2-Gdx.graphics.getHeight()/8,Gdx.graphics.getHeight()/2);
        ...
        exit.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent s, float x, float y){
                ...
                ((Game) Gdx.app.getApplicationListener()).setScreen(new pauseS());
        ...
        score.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent s, float x, float y){
                ...
                ((Game) Gdx.app.getApplicationListener()).setScreen(new High());
